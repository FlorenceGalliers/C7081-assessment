...
## Objectives:
* Understand which attributes of houses can be used to effectively construct a prediction model for house price.
...
**Figure 1**: A correlation map showing the correlations between variables according to spearmans correlation (excluding city, if_basement and if_renovated), the colours represent strength of correlation, the crosses show where the correlation is not significant.
...
# Results:
Link to [Github](https://github.com/FlorenceGalliers/C7081-assessment) repository containing fully reproducible methods script (C7081-Methods.R)
