...
This simple model was then expanded to allow all the other variables in the dataset, this is multiple linear regression. The model output showed that 17 of these variables had a significant impact (P<0.5) on the price, they were: bedrooms, bathrooms, sqft_living, condition, if_basement.1, house_age, city.Bellevue, city.Issaquah, city.Kent, city.Kirkland, city.Medina, city.Mercerisland, city.Redmond, city.Sammamish, city.Seattle, city.Shoreline, city.Woodinville.
