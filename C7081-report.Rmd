...
## Data:
The data for this analysis contains house prices and information regarding 
...
- Show code for how to change these variables?
- Remove outliers
- Check if there are any zero values as these are not acceptable in a housing price sitation, so we must remove these.
